              ...
              <ul>
                <li class="mb-4">
                  <label for="instock" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" id="instock" wire:model.live="instock" value="1" class="w-4 h-4 mr-2">
            ...
            <div class="px-3 mb-4">
              <div class="items-center justify-between px-3 py-2 bg-gray-50 md:flex dark:bg-gray-900 ">
                <div class="flex items-center justify-between">
                  <select name="" wire:model.live="sort" id="" class="block w-40 text-base bg-gray-50 cursor-pointer dark:text-gray-400 dark:bg-gray-900">
